...
| Lifetime | What | Where |
|---|---|---|
| Nearly permanent | Platform/SDK behaviour that is not obvious | `AGENTS.md` constraints section |
...
|---|---|---|
| Non-obvious platform/SDK behaviour | `AGENTS.md` constraints | Still true in a year **and** you would not guess it from the docs |
